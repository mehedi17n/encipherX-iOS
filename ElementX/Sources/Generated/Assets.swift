...
internal enum Asset {
  internal static let authBackgroundGrad = ImageAsset(name: "auth-background-grad")
  ...
  internal enum Images {
    ...
    internal static let buttonBg = ImageAsset(name: "images/button-bg")
  ...
  internal static let onboarding3BgOverlay = ImageAsset(name: "onboarding3-bg-overlay")
